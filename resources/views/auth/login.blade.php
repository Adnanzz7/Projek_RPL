...
<body class="min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('{{ asset('storage/bg.jpg') }}')">
    <div class="bg-white shadow-xl rounded-2xl max-w-5xl w-full p-10 md:flex md:items-start">
        ...
        <div class="md:w-1/2 w-full">
            <form method="POST" action="{{ route('login') }}">
                @csrf
                <div class="mb-4">
                    <input type="text" id="login" name="login" value="{{ old('login') }}" placeholder="Email atau Username"
                ...
                <div class="mb-2">
                    <div class="relative">
                        <input type="password" id="password" name="password" placeholder="Password"
                               class="w-full px-4 py-3 bg-white border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none placeholder-gray-400" required>
                        <button type="button"
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('password.request') }}" class="text-sm text-blue-600 font-semibold hover:underline">
                        Forgot password?
                    </a>
                </div>
                ...
                {{-- <p class="text-xs text-gray-400 mb-6">
                    ...
                    <a href="#" class="text-blue-400 hover:underline">Guest mode</a>
                </p> --}}
    ...
    {{-- <footer class="absolute bottom-2 w-full text-xs text-gray-400 text-center">
