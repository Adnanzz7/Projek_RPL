    ...
    <div class="container mx-auto py-12 px-6">
        <div class="max-w-4xl mx-auto bg-white bg-opacity-90 shadow-lg rounded-lg p-8">
            ...
            <div class="mt-8">
                ...
                <div id="paymentDetails" class="hidden mt-6">
                    ...
                    <div class="flex justify-center">
                        <img src="{{ asset('storage/QRIS.jpg') }}" alt="QRIS" class="qr-image w-56 h-auto border-4 border-green-500 rounded-md shadow-md animate-pulse">
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 flex justify-between">
                ...
                <form id="checkoutForm" action="{{ route('cart.completeCheckout') }}" method="POST">
                    @csrf
