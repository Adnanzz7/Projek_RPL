...
<div class="container mx-auto p-8">
    ...
    <div class="text-center mb-6">
        <a href="<?php echo e(route('dashboard')); ?>" class="inline-block bg-blue-500 text-white px-6 py-2 rounded-full hover:bg-blue-600 transition duration-300">Back to Dashboard</a>
    </div>
