...
<body class="flex flex-col min-h-screen font-['Roboto'] bg-white bg-opacity-80 text-white bg-cover bg-center bg-no-repeat" style="background-image: url('<?php echo e(asset('storage/bg.jpg')); ?>');">
        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <ul class="flex flex-col md:flex-row items-center space-x-0 md:space-x-8 list-none w-full md:w-auto">
                <li class="nav-item relative md:right-10 mb-2 md:mb-0 w-full md:w-auto">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="nav-link flex items-center justify-center md:justify-start space-x-2 text-base text-white normal-case hover:text-amber-400 transition duration-200 transform hover:scale-105">
                        <i class="fas fa-user-edit text-xl"></i>
                        <span>Edit profil</span>
                    </a>
                </li>
                <li class="nav-item relative md:right-10 mb-2 md:mb-0 w-full md:w-auto">
                    <a href="<?php echo e(route('logout')); ?>" class="nav-link flex items-center justify-center md:justify-start space-x-2 text-base text-white normal-case hover:text-red-400 transition duration-200 transform hover:scale-105"
...
</html><?php /**PATH C:\Users\HP\Laravel\Projek_RPL\resources\views/layouts/profile.blade.php ENDPATH**/ ?>