    ...
    <div class="container mx-auto py-12 px-6">
        <div class="max-w-5xl mx-auto bg-white bg-opacity-80 shadow-lg rounded-lg p-8 relative">
            ...
            <div class="absolute bottom-5 right-5 flex gap-4 mt-8"> <!-- Menambahkan margin top (mt-8) -->
                <!-- Tombol Download PDF -->
                <a href="<?php echo e(route('cart.downloadPdf', ['id' => $cart->id ?? 0])); ?>" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg shadow-lg transform transition-all duration-300 ease-in-out hover:translate-y-1">
                    Download PDF
                </a>
                
                <!-- Tombol Selesai -->
                <a href="<?php echo e(route('checkout.success')); ?>" class="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg shadow-lg transform transition-all duration-300 ease-in-out hover:translate-y-1">
                    Selesai
                </a>
            </div>            
