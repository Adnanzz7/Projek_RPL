                ...
                <?php $__currentLoopData = $barangs->where('kategori_barang', $key); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative bg-white border bg-opacity-80 rounded-2xl shadow-md overflow-hidden hover:shadow-lg hover:scale-105 transition-all duration-300 flex flex-col transform ease-in-out cursor-pointer">
                        ...
                        <div class="p-4 flex flex-col justify-between flex-1">
                            <h3 class="text-2xl font-bold text-gray-900 mb-2 truncate" title="<?php echo e($barang->nama_barang ?? 'Produk tidak ditemukan'); ?>">
                                <?php echo e($barang->nama_barang ?? 'Produk tidak ditemukan'); ?>

                            </h3>
                            <p class="text-pink-600 font-semibold text-xl mb-1">Rp <?php echo e(number_format($barang->harga_barang ?? 0, 0, ',', '.')); ?></p>
                            <p class="text-gray-600 text-sm mb-1">Stok: <?php echo e($barang->jumlah_barang ?? 0); ?></p>
                            <p class="text-gray-500 text-sm mb-4">Pengirim: 
                                <a href="<?php echo e(route('profile.show', $barang->user->id)); ?>" class="text-gray-500 hover:underline">
                                    <?php echo e($barang->user->name ?? '-'); ?>
