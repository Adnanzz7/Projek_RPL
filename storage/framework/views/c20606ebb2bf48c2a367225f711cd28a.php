...
<div class="min-h-screen bg-cover bg-center">
    <div class="flex justify-center items-center h-full py-5">
        <div class="bg-white bg-opacity-80 p-8 rounded-xl shadow-lg max-w-2xl w-full">
            ...
            <form action="<?php echo e(route('barangs.update', $barang)); ?>" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_barang" id="nama_barang" 
                           ...
                           value="<?php echo e(old('nama_barang', $barang->nama_barang)); ?>" required>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="harga_barang" id="harga_barang" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" 
                           value="<?php echo e(old('harga_barang', $barang->harga_pokok + 1500)); ?>" required oninput="updateHarga(); updateHargaWeb();">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="harga_dengan_retribusi" 
                           ...
                           readonly value="<?php echo e(old('harga_dengan_retribusi', $barang->harga_pokok + 2000)); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="harga_dengan_web" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-full shadow-sm bg-gray-100 text-gray-600" 
                           readonly value="<?php echo e(old('harga_dengan_web', $barang->harga_pokok + 2500)); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="jumlah_barang" id="jumlah_barang" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" 
                           value="<?php echo e(old('jumlah_barang', $barang->jumlah_barang)); ?>" required>
                </div>

                <!-- Upload Foto Barang dengan Drag & Drop & Preview Samping -->
                <div x-data="{ isDragging: false, fileName: '', previewUrl: '<?php echo e(asset('storage/' . $barang->foto_barang)); ?>' }" class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="keterangan_barang" id="keterangan_barang" rows="4" 
                            ...
                            placeholder="Tambahkan informasi tambahan tentang barang"><?php echo e(old('keterangan_barang', $barang->keterangan_barang)); ?></textarea>
                </div>

                <!-- Tombol Kembali dan Update -->
                <div class="flex justify-between mt-6 space-x-4">
                    <a href="<?php echo e(route('barangs.index')); ?>" class="bg-gray-600 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-gray-700 focus:ring-2 focus:ring-blue-500 transition transform hover:scale-105">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\laravel\Projek_RPL\resources\views/barangs/edit.blade.php ENDPATH**/ ?>