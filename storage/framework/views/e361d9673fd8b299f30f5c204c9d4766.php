...
<div class="container mx-auto p-8">
    ...
    <div class="max-w-md mx-auto mb-6">
        ...
        <div class="mt-4 flex justify-center space-x-4">
            <a href="<?php echo e(route('history.exportPdf')); ?>" class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition duration-200">Download PDF</a>
            <a href="<?php echo e(route('history.exportExcel')); ?>" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition duration-200">Download Excel</a>
        </div>
    </div>
